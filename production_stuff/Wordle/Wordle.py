...
def guess_word():
    ...
    if guessed_word not in Valid_Words:
        print("Sorry, but either you used an uppercase character, it is not in the Valid word bank (this is a limited word bank, and does not have every single five letter work in the world), you typed a space anywhere, or this is not a word. Please try again.")
        guess_word()
    else:
        return guessed_word
